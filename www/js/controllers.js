...
.controller('AthleteServiceDetailCtrl', function ($scope, $state, $ionicPopup, MyServices, $ionicLoading, $filter, $ionicModal) {
  $scope.servicePopup = {
...
.controller('AthleteEventDetailCtrl', function ($scope, $state, $ionicPopup, MyServices, $ionicLoading, $filter, $ionicModal) {
...
.controller('AthleteArticleDetailCtrl', function ($scope, $ionicModal, $timeout) {
...
.controller('AthleteServiceCtrl', function ($scope, $ionicModal, $timeout,$ionicPopup) {
...
.controller('AthleteEventsCtrl', function ($scope, $ionicModal, $timeout,$ionicPopup) {
